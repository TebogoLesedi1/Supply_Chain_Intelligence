...
| ------| -------- | --------------------------|----------------|
|Phase 1: Foundations| Weeks 1-2| Exploratory data profiling, ingestion orchestration, structuring standard Medallion architecture paths, formatign Gold star schema structures.| Functdional ETL and verified SQL data warehouse|
